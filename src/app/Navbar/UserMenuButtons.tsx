...
import placeholderImage from"@/assets/profile-pic-placeholder.png"
import { signIn, signOut } from "next-auth/react";


interface userMenuPropd{
     session:Session | null
}

const UserMenuButton=({session}:userMenuPropd)=>{
